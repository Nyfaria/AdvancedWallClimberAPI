...
/**
 * Jump controller for wall-climbing entities.
 * Handles directional jumping based on surface orientation.
 */
public class ClimberJumpController<T extends Mob & IAdvancedClimber> extends JumpControl {
